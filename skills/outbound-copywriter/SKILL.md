...
description: "Write high-converting cold email sequences using the SPARK framework (Subject, Personalized opening, Agitate pain, Relevant value, Kick-off CTA). Includes 7 copy archetypes, 7 power patterns, Chris Voss persuasion techniques, and a 4-step follow-up sequence. Use when writing cold outbound emails, email sequences, or sales prospecting copy."
---
